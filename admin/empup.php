...
<body>
	...
	<div class="wholeContent">
		...
		<div class="content">
		<h3><b>Update Employee Information</b>
		<br>
		<br>
		...
		<?php
			...
			?>
		<form action="empup.php?id=<?php echo $id?>" method=POST>	
		<table>
		<tr>
		...
		<tr>
			<td>Email Address: <td><input type=text placeholder='Email@talkshirt.com' name=email value='<?php echo $row->EMAIL?>'>
		...
		<tr>
			<td>Address:
			<td><textarea name='add' cols='34' rows='3' maxlength='100'><?php echo $row->ADDRESS?></textarea>
			<td>Job ID:
			<td><input type=text placeholder='Job ID' name=jobid size=5 value=<?php echo $row->JOB_ID?>>
		<tr>
			<td>Admin Priveleges:
			<td><input type=checkbox name=admin value='YES' class=check>	
		<tr>
