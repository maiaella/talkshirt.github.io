        ...
        <div class=" orders">
            <table border="1px solid #c0c0c0">
                ...
                <tbody>
                    ...
                    $query="SELECT * FROM talkshirt_orders WHERE users_id = '".$_SESSION['id']."'";
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($row['TYPE'] == 'cart') { ?>
                                <a href="ordersview.php?TRANSID=<?php echo $row['TRANSID'] ?>">VIEW</a></td>
                            <?php }else{ ?>
                                <a href="ordersview2.php?TRANSID=<?php echo $row['TRANSID'] ?>">VIEW</a></td>
                            <?php } ?>
