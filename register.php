...
<body>
	...
	<tr>
		<td>Name
	<tr>
		<td><input type=text placeholder='First*' name=fname required>
		<td><input type=text placeholder='Middle*' name=mname required>
		<td><input type=text placeholder='Last*' name=lname required>
	<tr>
		<td>Username*
		<br>
	...
	<tr>
		<td>Contact Number*
		<br><input type=text placeholder='63xxxxxxxxxx' name=contact required>
	<tr>
		<td>Create Password
		<br>
	...
	<tr>
		...
		<br>
		<textarea name='add1' cols='34' rows='3' maxlength='100' required></textarea>
	<tr>
		<td colspan=3>
		<br>
		<br>
		...
		<?php
			...
			$result2 = '';
			for ($x = 0; $x < 5; $x++)
				$result2 .= $characters[mt_rand(0, 61)];
		
		?>
		<input type=hidden name='captcha1' value='<?php echo "$result"; ?>'>
	...
	<tr>
		<td colspan=3>Terms of Use and Condtions
		<br>
		<textarea name='add2' cols='50' rows='10' >
TERMS OF SERVICES
...
This website is operated by Talkshirt. Throughout the site, the terms �we�, �us� and �our� refer to Talkshirt.Talkshirt offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
...
Our store is hosted on Talkshirt They provide us with the online e-commerce platform that allows us to sell our products and services to you.
...
Questions about the Terms of Service should be sent to us at scbcfurnitures@yahoo.com.
...
Our store is hosted on MESA They provide us with the online e-commerce platform that allows us to sell our products and services to you.
...
Depending on where you live, the time it may take for your exchanged product to reach you, may vary.
	...
	<tr>
		<td colspan=5><small>Clicking the I Agree and Sign Up button means that you are accepting 
		<br>the <a href='terms.php'>Talkshirt Terms of Use and the Privacy Statement</a>.</small>
		<br>
		<input type=submit name=submit value='I Agree and Sign Up' class=submit>
