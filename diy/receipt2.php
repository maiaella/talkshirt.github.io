...
include '../conn.php'; 
		...
		$query="SELECT *, cc.COLOR AS cc_COLOR, cc.TOTAL AS cc_TOTAL FROM talkshirt_customization_cart cc  INNER JOIN talkshirt_orders o ON cc.TRANSID=o.TRANSID WHERE o.STATUS = 'Pending'";
									...
									<div class="cartheader">
										<table width=800px>
											...
											<tr>
											    ...
											    <td><?php echo $row['cc_COLOR'] ?></td>
												<td><?php echo $row['cc_TOTAL'] ?></td>
											</tr>
											<?php } ?>
										</tbody>
										</table>
