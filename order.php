				...
				<div class='orderbox'>
					...
					<div class='cartheader'>
						...
						<table>
							...
							<tr><td align=center>Quantity: 	<td align=center><input type="text" name="quantity" required class="form-control prc"/>
					...
					<br>
						<table>
							<tr><td>Delivery Address: <td><textarea name='add' cols='34' rows='3' maxlength='100' required></textarea><br>
					...
					<?php $custinfo="SELECT * FROM talkshirt_users WHERE UNAME='$uname'";
						...
						$transid = $date2.$result;
							...
							<table width=650px style= 'font-size:40%'>
									...
									<tr><td align=right>Subtotal: Php <b>$total.00 
										<br>					 $quan pc(s)
							...
							<div class='cartheader'>
								<table width=600px >
										...
										<tr width=200px><td rowspan=5 align=left width=150px>$cusrow->FIRST_NAME $cusrow->LAST_NAME
																	<br>
																	$address
										<tr width=200px>
